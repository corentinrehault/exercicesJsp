...
public class Lecteur implements java.io.Serializable {
	...
	// 4.3.b Définition des methodes d’accès en écriture
	// Le nom du lecteur
	...
	// 4.3.c Définition des methodes d’accès en lecture
	// Le nom du lecteur
	...
	// Le numero unique du lecteur est formé par la combinaison
	// des deux premieres lettre de son prénoms suivies
